...
cargoHold[5] = 'space tether';
        // cargoHold.splice(5, 1, 'space tether'); also does this (without brackets)
console.log(cargoHold);
...
console.log(`The final array includes the following ${cargoHold.length} elements: [${cargoHold}].`)